...
export async function GET(request:Request, {params}:any) {
    ...
    if(term === null || term === undefined || term === '') {
        ...
        var res = await fetch(`https://public.opendatasoft.com/api/explore/v2.1/catalog/datasets/geonames-all-cities-with-a-population-1000/records?select=*&where=(name%20%3D%20%27${term}%27)%20or%20(ascii_name%20%3D%20%27${term}%27)%20or%20(alternate_names%20%3D%20%27${term}%27)&limit=20`); 
    }
        // headers: {
