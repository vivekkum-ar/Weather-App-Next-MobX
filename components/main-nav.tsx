...
const Navbar: React.FC<NavbarProps> = ({ }) => {
    ...
    return (
        <div className="px-4 md:px-6 lg:px-8 xl:px-10 flex-row-reverse flex justify-between py-2 bg-gradient-to-b dark:from-gray-600  dark:to-transparent from-gray-300  to-transparent">
                                ...
                                <li className="row-span-3">
                                    <NavigationMenuLink asChild>
                                        <a
                                            ...
                                            href="/"
                                        >
                                            <Icon icon="mdi:weather-partly-lightning" fontSize={80} style={{color: "white"}} />
