...
const Navbar: React.FC<NavbarProps> = ({ }) => {
    ...
    return (
        <div className="fixed w-full top-0 px-4 md:px-6 lg:px-8 xl:px-10 flex-row-reverse flex justify-between py-2 bg-gradient-to-b dark:from-gray-600  dark:to-transparent from-gray-300  to-transparent">
